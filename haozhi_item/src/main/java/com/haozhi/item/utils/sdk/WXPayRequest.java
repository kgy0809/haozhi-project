...
import static com.haozhi.item.utils.sdk.WXPayConstants.USER_AGENT;
...
public class WXPayRequest {
    ...
    private String requestOnce(final String domain, String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert) throws Exception {
        ...
        if (useCert) {
            ...
            InputStream certStream = this.inputStream();
            System.out.println(certStream.toString());
    ...
    //D:\Myeclipse\ssm\ssm_api\src\main\resource\apiclient_cert.p12
    ...
    private InputStream inputStream() throws IOException {
        InputStream certStream=WXPayRequest.class.getClassLoader().getResourceAsStream("apiclient_cert.p12");
//        int n=0;
//        byte[] bytes=new byte[1024];
//        while((n=certStream.read(bytes))!=-1);

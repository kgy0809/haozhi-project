package com.haozhi.common.enums;
...
public enum ExceptionEnum {
    ...
    INVALID_PHONE_NUMBER_EXIST(400, "手机号码已存在"),
    INVALID_PHONE_ERIFY_EXIST(400, "手机号码格式错误"),
    ...
    PAY_ERROR(500,"余额支付服务失败!"),
    UNAUTHORIZED(401, "登录失效或未登录！"),
    WITHDRAWAL_OF_FAILURE(500, "申请提现出错！");
